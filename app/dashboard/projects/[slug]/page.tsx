          ...
          <div className="flex flex-wrap gap-4 mb-8">
            {project.github && (
              <a
                ...
                className="bg-gray-800 hover:bg-gray-900 text-white font-semibold py-3 px-6 rounded-lg transition duration-200 flex items-center gap-2 border-2 border-gray-600 hover:border-gray-500"
              >
