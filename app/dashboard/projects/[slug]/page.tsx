          ...
          <div className="flex flex-wrap gap-4 mb-8">
            {project.github && (
              <a
                ...
                className="bg-slate-600 hover:bg-slate-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-200 flex items-center gap-2 border-2 border-slate-400 hover:border-slate-300 shadow-lg"
              >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-200 flex items-center gap-2 border-2 border-blue-500 hover:border-blue-400"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
