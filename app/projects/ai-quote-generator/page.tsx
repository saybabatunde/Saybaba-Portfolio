      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          ...
          >
            ...
            <p className="text-white font-semibold">Try Generator</p>
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
            <p className="text-gray-400 text-sm mb-2">🤖 AI Engine</p>
            <p className="text-white font-semibold">Claude API</p>
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-8">
          ...
          {activeTab === 'tech' && (
            <div className="space-y-6">
              ...
              <div className="bg-purple-900/20 border border-purple-600 rounded-lg p-6 mt-8">
        ...
        <section className="mt-12">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={idx} className="bg-gray-800 border border-gray-700 rounded-lg p-6 flex gap-4">
