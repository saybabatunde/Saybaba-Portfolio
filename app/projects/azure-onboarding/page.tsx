        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <h1 className="text-3xl font-bold text-white">Azure User Onboarding Portal</h1>
              <p className="text-gray-400 text-sm mt-1">Multi-Cloud Demo on Azure Static Web Apps</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-gray-800 rounded-lg border border-gray-700 p-8">
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <div>
                <p className="font-semibold text-white mb-1">4. Multi-Cloud Architecture</p>
